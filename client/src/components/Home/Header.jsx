...
const Header = () => {
    ...
    return (
        <div className="shadow-sm flex flex-row justify-center border-b-2 border-pink-600 bg-gray-700">
            <div className="justify-items-center items-center p-2 font-shantell pr-4">
                <p className="text-4xl bg-gradient-to-r from-pink-500 to-blue-400 bg-clip-text text-transparent font-bold">Blogify</p>
            </div>
        <header className="text-slate-100 p-2 bg-gray-700">
